...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-7uu1qjs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-7uu1qjs.containers.anotherwebservice.com/
...
```
git clone git@github.com:kris-mhc/container-7uu1qjs.git
cd container-7uu1qjs
```
...
```
docker attach container-7uu1qjs
```
